...
import withErrorHandler from '../../../hoc/withErrorHandlers/withErrorHanlers'
...
const mapDispatchTOProps = dispatch => {
    return {
        onBurgerPurchase: (orderData) => dispatch(actionTypes.purchaseOrder(orderData))
    }
}

export default connect(mapStateToProps, mapDispatchTOProps)(ContactData)(withErrorHandler(ContactData, axios))